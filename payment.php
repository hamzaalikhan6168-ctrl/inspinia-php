                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <div class="float-right">
                                            <i class="fa fa-cc-easypaisa text-success"></i>
                                        </div>
                                        <h5 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Easy Paisa</a>
                                        </h5>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-10">
                                                    ...
                                                    <a class="btn btn-success" href="">
                                                        <i class="fa fa-cc-easypaisa"> </i> Purchase via Easy Paisa
                                                    </a>
