<div class="footer">
    ...
    <!-- Jvectormap -->
    <script src="theme/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="theme/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- EayPIE -->
    <script src="theme/js/plugins/easypiechart/jquery.easypiechart.js"></script>

    <!-- Sparkline -->
    <script src="theme/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="theme/js/demo/sparkline-demo.js"></script>
